...
class RenewMarketingCampaignAction
{
    /**
    ...
    public function execute(MarketingCampaign $campaign, array $data): MarketingCampaignPeriod
    {
        ...
        if (isset($data['starts_at']) && $data['starts_at']) {
            $campaign->update(['starts_at' => Carbon::parse($data['starts_at'])]);
        }
        ...
        return $campaign->periods()->create([
            ...
            'description' => $data['description'] ?? 'Rinnovo campagna',
