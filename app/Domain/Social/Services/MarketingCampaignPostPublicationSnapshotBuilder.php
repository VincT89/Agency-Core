...
class MarketingCampaignPostPublicationSnapshotBuilder
{
    public function build(
        ...
        return new MarketingCampaignPostPublicationSnapshot(
            ...
            title: $version->title ?? throw new \InvalidArgumentException("Missing title for version {$version->id}"),
            caption: $version->caption ?? throw new \InvalidArgumentException("Missing caption for version {$version->id}"),
            hashtags: $version->hashtags ?? throw new \InvalidArgumentException("Missing hashtags for version {$version->id}"),
            media: $mediaData,
