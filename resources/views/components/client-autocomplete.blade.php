...
>
    ...
    <div x-show="isOpen" 
         ...
         <ul class="ca-results-list">
             ...
             <li x-show="!loading && search.length >= 1 && results.length === 0" class="ca-empty-state">
                 Nessun cliente trovato.
             </li>
             
             <li x-show="search.length < 1 && search.length > 0" class="ca-empty-state">
                 Digita almeno 1 carattere per cercare.
             </li>
         </ul>
