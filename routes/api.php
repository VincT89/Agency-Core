...
Route::prefix('v1/integrations/n8n')
    ...
    ->group(function () {
        ...
        Route::post('/marketing-campaign-posts/{post}/failed', [\App\Http\Controllers\Api\V1\Integrations\N8n\MarketingCampaignPostFailedController::class, 'store'])->name('marketing-campaign-posts.failed');
        ...
        Route::post('/chatbot/outgoing-messages/{messageId}/status', [\App\Http\Controllers\Api\V1\Integrations\N8n\N8nChatbotController::class, 'updateOutgoingMessageStatus'])->name('chatbot.outgoing-messages.status');
    });
