...
<?php $component = App\View\Components\AppLayout::resolve(['title' => 'Pagamenti'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['eyebrow' => 'Modulo · Amministrazione','meta' => $payments->total() . ' totali']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['eyebrow' => 'Modulo · Amministrazione','meta' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($payments->total() . ' totali')]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

     <?php $__env->slot('title', null, []); ?> <strong>Pagamenti</strong> <?php $__env->endSlot(); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Payment::class)): ?>
                <a href="<?php echo e(route('payments.create')); ?>" class="btn btn-p">+ Registra pagamento</a>
            <?php endif; ?>
         <?php $__env->endSlot(); ?>
        ...
        <table class="t-table">
            ...
            <tbody>
                ...
                <tr onclick="window.location='<?php echo e(route('payments.show', $payment)); ?>'" style="cursor:pointer">
                    <td class="mono-col"><?php echo e($payment->payment_date?->format('d/m/Y')); ?></td>
                    <td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->invoice): ?>
                            <a href="<?php echo e(route('invoices.show', $payment->invoice)); ?>" style="color:var(--accent);text-decoration:none"><?php echo e($payment->invoice->number); ?></a>
                        <?php else: ?>
                            —
...
<?php endif; ?></td>
                    <td><?php echo e($payment->creator?->name ?? 'Sistema'); ?></td>
                    <td>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $payment)): ?>
                            <a href="<?php echo e(route('payments.edit', $payment)); ?>" class="btn-icon" onclick="event.stopPropagation()">✎</a>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php endif; ?><?php /**PATH C:\Users\vince\OneDrive\Desktop\SODANO\GESTIONALE\Agency-core\resources\views/payments/index.blade.php ENDPATH**/ ?>