<div>
    <div style="margin-bottom:24px;">
        <a href="<?php echo e(route('photography.shooting.index')); ?>" style="color:var(--text3); font-size:13px; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
