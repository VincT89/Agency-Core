<div>
    <div style="margin-bottom:15px">
        <a href="<?php echo e(route('marketing-projects.index')); ?>" wire:navigate style="color:var(--text3);font-size:12px;text-decoration:none">← Torna ai progetti</a>
    </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
         ...
         <?php $__env->slot('title', null, []); ?> <strong><?php echo e($project->title); ?></strong> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <div style="display:flex;gap:15px;align-items:center;margin-bottom:20px;padding-bottom:15px;border-bottom:1px solid var(--line);">
        <div style="font-size:13px;color:var(--text2);">Cliente: <strong style="color:var(--text);"><?php echo e($project->client->name ?? '-'); ?></strong></div>
        <div style="color:var(--line3);">|</div>
        <div style="font-size:13px;color:var(--text2);">Tipo: <strong style="color:var(--text);"><?php echo e($project->type->label()); ?></strong></div>
        <div style="color:var(--line3);">|</div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel','data' => ['title' => 'Dettagli Briefing','padded' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dettagli Briefing','padded' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

                <div style="margin-bottom:15px;">
                    <strong class="mkt-detail-label">Piattaforme Destinazione</strong>
                    <div class="mkt-checkbox-group" style="margin-top:5px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $project->platforms ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div style="margin-bottom:15px;">
                    ...
                    <p class="mkt-detail-value"><?php echo e($project->publication_mode->label()); ?></p>
                </div>
...
<?php endif; ?>
        ...
        <div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->type->value === 'editorial_plan' && $project->editorialPlan): ?>
                <?php if (isset($component)) { $__componentOriginal36665f0dc0e45320e21db1e20a989acf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal36665f0dc0e45320e21db1e20a989acf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel','data' => ['title' => 'Piano Editoriale','padded' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('panel'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Piano Editoriale','padded' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

                    <div class="mkt-plan-stats">
                        <span>Inizio: <strong><?php echo e($project->editorialPlan->start_date?->format('d/m/Y')); ?></strong></span>
                        <span>Fine: <strong><?php echo e($project->editorialPlan->end_date?->format('d/m/Y')); ?></strong></span>
                        <span>Slot: <strong><?php echo e($project->editorialPlan->post_count); ?></strong></span>
                    </div>
                        ...
                        <div class="mkt-slot-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $project->editorialPlan->slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="mkt-slot-item">
                                    <div>
                                        <div class="mkt-slot-date"><?php echo e($slot->scheduled_date?->format('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($slot->scheduled_time)->format('H:i')); ?></div>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal36665f0dc0e45320e21db1e20a989acf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal36665f0dc0e45320e21db1e20a989acf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel','data' => ['title' => 'Integrazione n8n','padded' => true,'style' => 'margin-top:20px;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('panel'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Integrazione n8n','padded' => true,'style' => 'margin-top:20px;']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->n8n_request_id): ?>
                    <div class="mkt-info-box">
                        <div style="margin-bottom:8px;"><strong class="mkt-detail-label" style="display:inline;">Richiesta ID:</strong> <br><span class="mkt-monospace"><?php echo e($project->n8n_request_id); ?></span></div>
                        <div><strong class="mkt-detail-label" style="display:inline;">Inviato il:</strong> <br><?php echo e($project->submitted_to_n8n_at?->format('d/m/Y H:i:s')); ?></div>
                    </div>
                <?php else: ?>
