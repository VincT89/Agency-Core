          ...
          ">
              <div style="padding:10px 14px;border-bottom:1px solid var(--line);display:flex;justify-content:space-between;align-items:center">
                  ...
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($unreadNotificationsCount) && $unreadNotificationsCount > 0): ?>
                    <div style="display:flex;align-items:center;gap:12px">
                        <form method="POST" action="<?php echo e(route('notifications.readAll')); ?>" style="margin:0" onsubmit="event.stopPropagation();">
                            <?php echo csrf_field(); ?>
                        ...
                        <span style="font-size:10px;background:var(--red);color:#fff;padding:2px 6px;border-radius:10px;white-space:nowrap"><?php echo e($unreadNotificationsCount); ?> nuove</span>
                    </div>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              </div>
              <div style="max-height:300px;overflow-y:auto">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestNotifications ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                      ...
                      <div style="position:relative;border-bottom:1px solid var(--line);background: <?php echo e($notification->read_at ? 'transparent' : 'var(--bg3)'); ?>;" 
                          ...
                          <form method="POST" action="<?php echo e(route('notifications.read', $notification->id)); ?>" style="margin:0">
                              ...
                              ">
                                  ...
                                  <div style="font-size:12px;font-weight:600;color:var(--text);margin-bottom:4px;display:flex;align-items:center;gap:6px;">
                                      <i data-lucide="<?php echo e($iconName); ?>" width="14" height="14" stroke-width="2" style="color:var(--text2)"></i>
                                      <span><?php echo e($notification->data['title'] ?? 'Nuova Notifica'); ?></span>
                                  </div>
                                  <div style="font-size:11px;color:var(--text2);line-height:1.4"><?php echo e($notification->data['message'] ?? ''); ?></div>
      ...
      <div style="position:relative" id="avatar-wrap">
          ...
          ">
              <div style="padding:10px 14px;border-bottom:1px solid var(--line)">
                  ...
                  <div style="font-family:var(--mono);font-size:10px;color:var(--text3)"><?php echo e(auth()->user()->role->value); ?></div>
              </div>
...
<?php /**PATH C:\Users\vince\OneDrive\Desktop\SODANO\GESTIONALE\Agency-core\resources\views/layouts/app.blade.php ENDPATH**/ ?>