...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['eyebrow' => 'Amministrazione','title' => 'Gestione Shooting']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['eyebrow' => 'Amministrazione','title' => 'Gestione Shooting']); ?>
        ...
        <div style="display:flex; gap:16px; margin-bottom:24px;">
            ...
            <select wire:model.live="status" class="form-in" style="max-width:200px;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <option value="<?php echo e($st->value); ?>"><?php echo e($st->labelForContext('admin')); ?></option>
...
<?php endif; ?>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.shooting.show', $shoot)); ?>" class="btn btn-outline" style="padding:4px 8px; font-size:12px;">Gestisci</a>
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\vince\OneDrive\Desktop\SODANO\GESTIONALE\Agency-core\resources\views/livewire/admin/shooting/shoots-index.blade.php ENDPATH**/ ?>