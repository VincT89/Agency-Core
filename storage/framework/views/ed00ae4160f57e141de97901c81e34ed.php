<div>
    <div style="margin-bottom:15px">
        <a href="<?php echo e(route('social.shooting.index')); ?>" wire:navigate style="color:var(--text3);font-size:12px;text-decoration:none">← Torna alle richieste</a>
    </div>

    <div class="mb-4">
        <?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['eyebrow' => 'Social','meta' => 'Compila i dettagli e proponi le date per avviare il workflow con il reparto fotografia.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['eyebrow' => 'Social','meta' => 'Compila i dettagli e proponi le date per avviare il workflow con il reparto fotografia.']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

             <?php $__env->slot('title', null, []); ?> <strong>Nuova Richiesta Shooting</strong> <?php $__env->endSlot(); ?>
