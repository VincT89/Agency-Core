...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['eyebrow' => 'Modulo · Social','meta' => $posts->total() . ' totali']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['eyebrow' => 'Modulo · Social','meta' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($posts->total() . ' totali')]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

         <?php $__env->slot('title', null, []); ?> <strong>Archivio Social Post</strong> <?php $__env->endSlot(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr onclick="window.location='<?php echo e(route('social.posts.show', $post)); ?>'" style="cursor:pointer">
                        ...
                        <td class="name-col">
                            ...
                            <div class="social-index-meta">v<?php echo e($post->currentVersion->version_number ?? 1); ?></div>
                        </td>
                        <td>
                            <div><?php echo e($post->project?->name ?? 'Nessun Progetto'); ?></div>
                            <div class="social-index-meta"><?php echo e($post->client?->name ?? 'Nessun Cliente'); ?></div>
                        </td>
                        <td>
                            <span class="badge" style="background: <?php echo e($post->status->color()); ?>; color: #fff; border: none;"><?php echo e($post->status->label()); ?></span>
                        </td>
                        <td class="mono-col">
